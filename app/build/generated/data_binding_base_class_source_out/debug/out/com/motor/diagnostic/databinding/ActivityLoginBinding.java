...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull MaterialButton btnLogin,
      ...
      @NonNull TextView tvInitializing) {
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      TextView tvInitializing = ViewBindings.findChildViewById(rootView, id);
      if (tvInitializing == null) {
        break missingId;
      }

      return new ActivityLoginBinding((ConstraintLayout) rootView, btnLogin, btnSignUp, etEmail,
          etPassword, ivLogo, progressBar, tilEmail, tilPassword, tvAppName, tvDontHaveAccount,
          tvForgotPassword, tvInitializing);
    }
